...
function PaddleSelectState:update(dt)
	...
	-- select paddle and move to the serve state, passing the selection
...
function PaddleSelectState:render()
	...
	love.graphics.printf('Select ypur paddle with left and right!', 0, VIRTUAL_HEIGHT / 4,
	...
	-- reset drawing color to full white for proper rending
	love.graphics.setColor(1, 1, 1, 1)

	-- right arrow; should render normally if we're less then 4, else
	...
	-- draw the paddle itself, base on twhich we have selected
	love.graphics.draw(gTextures['main'], gFrames['paddle'][2 + 4 * (self.currentPaddle - 1)],
